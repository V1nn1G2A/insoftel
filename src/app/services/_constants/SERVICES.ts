    ...
    paginatedInfo: [
      {
        ...
        text: 'Develop clear, actionable plans that outline your technology goals, ensuring alignment with your broader business objectives.',
        width: 'w540',
      },
      {
        title: 'Infrastructure Design:',
        text: 'Build a secure, scalable, and resilient IT foundation that supports your organisation’s growth and adaptability.',
        width: 'w540',
      },
      {
        title: 'Cloud Solutions & DevOps Integration:',
        text: 'Enhance efficiency and scalability with cloud infrastructure, while DevOps practices streamline development cycles and deployment.',
      },
      {
        title: 'Digital Transformation Guidance:',
        text: 'Navigate your digital journey with expert advice, ensuring each step is aligned with your vision and maximises return on investment.',
      },
    ],
  },
  {
